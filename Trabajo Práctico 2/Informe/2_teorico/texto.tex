...
\begin{table}[ht]
    ...
    $Q_4$      & BS170-D    & n\_MOS enr. &  & $R_{ref}$  & XXX   & $\si{\kilo\ohm}$ &  &            &       &                    \\ \cline{1-3} \cline{5-7} \cline{9-11} 
    \end{tabular}
    \caption{Componentes elegidos}
\end{table}

A partir de los valores de estos componentes, se calcularon los parámetros del circuito.

\begin{table}[ht]
    \centering
    \begin{tabular}{|r|r|r|r|}
        \hline
        \multicolumn{2}{|r|}{Par Darlington}                     & $Q_1$  & $Q_2$  \\ \hline
        \multicolumn{2}{|r|}{Componente}                         & BC547B & BC547B \\ \hline
        \multirow{2}{*}{Polarización}            & $I_{CQ}$      &        &        \\ \cline{2-4} 
                                                 & $V_{CE}$      &        &        \\ \hline
        \multirow{3}{*}{Parámetros H}            & $h_{ie}$      &        &        \\ \cline{2-4} 
                                                 & $h_{fe}$      &        &        \\ \cline{2-4} 
                                                 & $h_{oe}$      &        &        \\ \hline
        \multirow{8}{*}{Circuito Incremental}    & $\Delta_v$    &        &        \\ \cline{2-4} 
                                                 & $\Delta_i$    &        &        \\ \cline{2-4} 
                                                 & $Z_i$         &        &        \\ \cline{2-4} 
                                                 & $Z_o$         &        &        \\ \cline{2-4} 
                                                 & $\Delta_{vs}$ &        &        \\ \cline{2-4} 
                                                 ...
                                                 & $Z_{ia}$      &        &        \\ \cline{2-4} 
                                                 & $Z_{oa}$      &        &        \\ \hline
        \multirow{2}{*}{Respuesta en Frecuencia} & $f_L$         &        &        \\ \cline{2-4} 
                                                 & $f_H$         &        &        \\ \hline
    \end{tabular}
    \caption{Parámetros teóricos de los transistores del Par Darlington}
    \label{tab:vals_teo}
\end{table}
