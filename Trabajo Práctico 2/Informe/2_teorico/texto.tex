...
me traería aparejada una gran pérdida en la impedancia de entrada del dispositivo. Sin embargo, también es 
necesario considerar que aumentar $R_B$  tiene un efecto colateral en la corriente de emisor 
de $Q_2$ dada por la ecuación[\ref{eq:pol_I_E2}]. De esta manera, ya no podríamos asumir un error despreciable y la 
ecuación [\ref{eq:pol_I_E2}] ya no sería válida. \par 
...
\newpage
\footnotetext[2]{Estimado gráficamente de la hoja de datos}
