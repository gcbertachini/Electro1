...
En primer lugar se definieron los transistores a utilizar:
...
\begin{table}[ht]
    ...
    $Q_1$      & BC547B     & BJT NPN     &  & $R_S$      & XXX   & $\si{\kilo\ohm}$ &  & $R_L$      & XXX   & $\si{\kilo\ohm}$   \\
    $Q_2$      & BC547B     & BJT NPN     &  & $R_B$      & XXX   & $\si{\kilo\ohm}$ &  & $C_i$      & 100   & $\si{\nano\farad}$ \\
    $Q_3$      & BS170-D    & n-MOS enr.  &  & $R_E$      & XXX   & $\si{\kilo\ohm}$ &  & $C_L$      & 100   & $\si{\nano\farad}$ \\
    $Q_4$      & BS170-D    & n\_MOS enr. &  & $R_{ref}$  & XXX   & $\si{\kilo\ohm}$ &  &           $R_{\text{o mos}}$&       &                    \\ \cline{1-3} \cline{5-7} \cline{9-11} 
    \end{tabular}
    \caption{Componentes elegidos}
\end{table}

A partir de los valores de estos componentes, se calcularon los parámetros del circuito. Se consideraron como primera aproximación un valor de $V_T = 25.2 \si{\milli\volt}$ y $V_A = 75 \si{\volt}$. 
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|r|r|r|r|}
        ...
        $I_{CQ} (\si{\milli\ampere})$ &  &  &  &  \\
        $V_{CE} (\si{\volt})$ &  &  &  &  \\
        $V_{CB} (\si{\volt})$ &  &  &  &  \\ \hline
    \end{tabular}
    \caption{Valores teóricos de polarización}
    \label{tab:vals_teo_pol}
\end{table}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|r|r|r|r|}
        ...
        \multirow{2}{*}{} & \multicolumn{2}{c|}{Carga Pasiva} & \multicolumn{2}{c|}{Carga Activa} \\ \cline{2-5} 
         & $Q_1$ & $Q_2$ & $Q_1$ & $Q_2$ \\ \hline
        $h_{fe} (\si{\ampere}/\si{\ampere})$ &  &  &  &  \\
        $h_{ie} (\si{\ohm})$ &  &  &  &  \\
        $h_{oe} (\si{\siemens})$ &  &  &  &  \\
        $C_{cb} (\si{\pico\farad})$ &  &  &  &  \\ \hline
    \end{tabular}
    \caption{Valores teóricos del modelo incremental}
    \label{tab:vals_teo_h}
\end{table}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|r|r|r|r|}
        ...
        $r_o$ &  &  &  &  \\ \hline
    \end{tabular}
    \caption{Valores incrementales del modelo incremental}
    \label{tab:vals_teo_inc}
\end{table}
