...
Ya que teóricamente, por las ecuaciones \ref{eq:pol_I_E2} y \ref{eq:pol icq}, la corriente de colector depende unicamente de valores conocidos, se ignora otra razón para estos resultados mas allá de errores de medición.
Por otro lado las tensiones colector-emisor con ambas cargas en $Q2$ se acercan a lo esperado teóricamente. Y las corrientes de colector presentan una diferencia de unos pocos mili amperes con la teoría. Esto es sencillamente atribuible al hecho de que como se trata de transistores reales, su parámetro de ganancia de corriente se encuentra dentro de un gran rango de valores. Muy probablemente el que se toma para el calculo teórico no es el que presentan los transistores en la realidad.
