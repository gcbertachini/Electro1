...
Ya que teóricamente, por las ecuaciones \ref{eq:pol_I_E2} y \ref{eq:pol icq}, la corriente de colector depende unicamente de valores conocidos, se ignora otra razón para estos resultados mas allá de errores de medición. Aún se investiga la razón de esta diferencia. %(NO SE ME OCURRE OTRA COSA, A USTEDES????)
