...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{3_simulacion/fig/ganancia_corriente_pasiva.png}
    \label{mediciones_pol_activa}
    \caption{Punto de operación del circuito en CC}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{3_simulacion/fig/ganancia_corriente_activa.png}
    \label{mediciones_pol_activa}
    \caption{Punto de operación del circuito en CC}
\end{figure}
